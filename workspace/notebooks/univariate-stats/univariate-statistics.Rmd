...
It's too much work with large datasets, unless you have a computer. Far too many steps to find the mean then subtract that from each one of the data points, square each of those numbers, and then add all of them up. 
