---
title: "R Notebook: o-well 1 draft 1"
...
# make.names(names);
# .rowNamesDF(owell.metals) = (NA,"Well 1","Well 2","Well 3","Well 4","Well 5","Well 6","Well 7","Well 8","Well 9","Well 10","Well 11","Well 12","Well 13","Well 14","Well 15","Well 16","Well 17","Well 18","Well 19","Well 20","Well 21","Well 22","Well 23");
```

```{r}
latitudeMatrix = matrix(c(28.63811,28.603468,28.575879,28.620362,28.560586,28.602789,28.488311,28.572316,28.438361,28.553648,28.651337,28.584441,28.512148,28.448275,28.625897,28.612935,28.54015,29.248557,29.234329,29.291152,29.336922,29.319727,29.24509));
...
owell.metalsGeologyList = list("sand,granite","sand,granite,alkaline","alkaline,conglomerate","alkaline","volcanic,granite","volcanic","gypsum","alkaline","gypsum","volcanic,conglomerate","alkaline,granite",NA,"gypsum","gypsum","volcanic","volcanic,granite,alkaline","gypsum,conglomerate","sand","sand","sand","sand","sand","alkaline,granite");
...
```{r}
owell.chemistryGeologyList = list(NA,"sand,granite","sand,granite,alkaline","alkaline,conglomerate","alkaline","volcanic,granite","volcanic","gypsum","alkaline","gypsum","volcanic,conglomerate","alkaline,granite",NA,"gypsum","gypsum","volcanic","volcanic,granite,alkaline","gypsum,conglomerate","sand","sand","sand","sand","sand","alkaline,granite");
